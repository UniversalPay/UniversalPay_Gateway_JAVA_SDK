...
UniversalPay Java SDK is a small library/sample of Java code that you can use to quickly integrate with the UniversalPay system and submit transactions, check their status and more.
...
UniversalPay Java SDK is delivered as Maven project. The possible profiles:
